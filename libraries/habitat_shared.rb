...
module Habitat
  module Shared
    # REMOVING THESE FOR TESTING
    # No logical reason to force this versioning.
    # HAB_VERSION = '1.5.86'.freeze
    # LINUX_LAUNCHER_VERSION = '13553'.freeze
    # WINDOWS_LAUNCHER_VERSION = '13553'.freeze
